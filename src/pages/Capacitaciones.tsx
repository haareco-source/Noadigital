        ...
        <section className="py-16 md:py-24">
          <div className="container max-w-4xl">
            ...
            <div className="prose prose-lg max-w-none text-muted-foreground space-y-4">
              <p>
                En <span className="text-primary font-semibold">FABRI3D</span>, ofrecemos programas de capacitación diseñados para profesionales, equipos técnicos y estudiantes que buscan desarrollar competencias en las tecnologías más demandadas de la actualidad.
              </p>
              <p>
