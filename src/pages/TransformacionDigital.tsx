        ...
        <section className="py-16 md:py-24">
          <div className="container max-w-4xl">
            ...
            <div className="prose prose-lg max-w-none text-muted-foreground space-y-4">
              ...
              <p>
                En <span className="text-primary font-semibold">NOADIGITAL</span>, acompañamos a empresas en su proceso de modernización mediante la implementación de soluciones de <strong>IoT, Cloud Computing, Inteligencia Artificial y automatización</strong>, adaptadas a las necesidades específicas de cada industria.
              </p>
              <p>
